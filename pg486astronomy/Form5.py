...
class Form5(Form):
	...
	def InitializeComponent(self):
		...
		self._button1.Location = System.Drawing.Point(151, 167)
...
Mass
 Temperature at cloud tops"""
		...
		self.ClientSize = System.Drawing.Size(415, 278)
		self.Controls.Add(self._button1)
		self.Controls.Add(self._groupBox1)
		self.Name = "Form5"
		self.Text = "Form5"
		self.FormClosing += self.Form5FormClosing
	...
	def Form5FormClosing(self, sender, e):
		self.parent.Show()
		pass