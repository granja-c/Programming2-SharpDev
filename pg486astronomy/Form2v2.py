...
class Form2v2(Form):
	...
	def InitializeComponent(self):
		...
		self._button1.Location = System.Drawing.Point(147, 158)
...
Surface temperature"""
		...
		self.ClientSize = System.Drawing.Size(381, 247)
		self.Controls.Add(self._button1)
		self.Controls.Add(self._groupBox1)
		self.Name = "Form2v2"
		self.Text = "Form2v2"
		self.FormClosing += self.Form2v2FormClosing
	...
	def Form2v2FormClosing(self, sender, e):
		self.parent.Show()
		pass