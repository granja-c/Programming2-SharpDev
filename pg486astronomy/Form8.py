...
class Form8(Form):
	...
	def InitializeComponent(self):
		...
		self._button1.Location = System.Drawing.Point(170, 176)
...
Temperature at cloud tops"""
		...
		self.ClientSize = System.Drawing.Size(461, 274)
		self.Controls.Add(self._button1)
		self.Controls.Add(self._groupBox1)
		self.Name = "Form8"
		self.Text = "Form8"
		self.FormClosing += self.Form8FormClosing
	...
	def Form8FormClosing(self, sender, e):
		self.parent.Show()
		pass